...
{
    _background = [[SKSpriteNode alloc] initWithColor:[SKColor redColor] size:CGSizeMake(self.frame.size.width, self.frame.size.height)];
...
{
    _gameButton = [[SKSpriteNode alloc] initWithColor:[SKColor blueColor] size:CGSizeMake(100, 30)];
